...
head(out)
```
# Learn error rates using machine learning/AI
```{r}
...
# create sequence table. Our output will print the dimensions of our table
```{r}
...
# assign taxonomy to a variable called taxa
